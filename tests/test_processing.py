...
def test_filter_by_state(
    list_with_state: list[dict[str, str]],
    list_without_state: list[dict[str, str]],
    state_canceled: list[dict[str, str]],
) -> None:
...
def test_sort_by_date(data_list: list[dict[str, str]], reverse_data_list: list[dict[str, str]]) -> None:
